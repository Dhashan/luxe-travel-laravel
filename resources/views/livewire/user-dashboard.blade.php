                ...
                @else
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-10">
                        @foreach($recentBookings as $index => $booking)
                            <article class="group bg-white rounded-[2rem] lg:rounded-[3rem] overflow-hidden shadow-sm hover:shadow-2xl hover:-translate-y-2 transition duration-700 animate-in fade-in slide-in-from-bottom-8 duration-700" style="animation-delay: {{ 600 + ($index * 100) }}ms">
