    ...
    <div class="w-full max-w-xl">
        <div class="bg-white rounded-[2.5rem] lg:rounded-[3.5rem] p-10 lg:p-16 shadow-[0_32px_64px_-16px_rgba(0,0,0,0.05)] border border-gray-50 animate-in fade-in zoom-in-95 duration-700">
            <header class="text-center mb-10 lg:mb-12">
                <p class="text-yellow-600 text-[8px] lg:text-[10px] font-black uppercase tracking-[0.4em] mb-4">Secure Portal</p>
                <h2 class="text-4xl lg:text-5xl font-black text-gray-900 tracking-tighter leading-none">Welcome <span class="text-yellow-600 italic">Back.</span></h2>
            </header>
            ...
            <form wire:submit="login" class="space-y-6 lg:space-y-8">
                <div class="space-y-4 lg:space-y-6">
                    <div class="group">
                        <label for="email" class="text-[8px] lg:text-[10px] font-black uppercase tracking-widest text-gray-400 mb-2 block ml-4">Credentials</label>
                    ...
                    <div class="group">
                        <label for="password" class="text-[8px] lg:text-[10px] font-black uppercase tracking-widest text-gray-400 mb-2 block ml-4">Security Key</label>
                ...
                <div class="pt-4">
                    <button type="submit" 
                            class="w-full py-5 bg-yellow-600 text-white rounded-full text-[10px] lg:text-xs font-black uppercase tracking-widest hover:bg-yellow-700 hover:-translate-y-1 transition duration-300 shadow-xl shadow-yellow-600/20 active:translate-y-0 text-center">
                        Private Entry
                    </button>
                </div>
